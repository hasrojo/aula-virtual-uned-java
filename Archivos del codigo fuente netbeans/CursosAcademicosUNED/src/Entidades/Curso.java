...
///
///representa un curso con su código nombre y estado (activo/inactivo)
///
public class Curso {
    ...
    ///
    public Curso(String codigo, String nombre, boolean activo) {
        this.codigo = codigo;
        this.nombre = nombre;
        this.activo = activo;
    }
    ...
    ///
    ///devuelve una representación legible del curso para mostrar en combos
    ///
@Override
