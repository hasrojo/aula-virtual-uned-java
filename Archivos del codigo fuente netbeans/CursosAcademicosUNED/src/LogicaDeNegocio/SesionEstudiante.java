...
///
///clase que guarda el estudiante que inició sesión en el sistema.
///
public class SesionEstudiante {

    private static Estudiante estudianteActual;

    ///establece el estudiante que inició sesión
    public static void establecerEstudiante(Estudiante estudiante) {
        estudianteActual = estudiante;
    }

    ///devuelve el estudiante que está en sesión
