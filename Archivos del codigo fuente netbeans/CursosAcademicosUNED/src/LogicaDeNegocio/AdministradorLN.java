...
import AccesoADatos.AdministradorAD;
import Entidades.Administrador;

///
///clase para validar el login del administrador
///
public class AdministradorLN {

    ///
    ///valida si las credenciales ingresadas coinciden con el administrador.
    ///
    public static boolean validarCredenciales(String usuarioIngresado, String contrasenaIngresada) {
        Administrador admin = AdministradorAD.obtenerAdministrador();

        return admin.getUsuario().equals(usuarioIngresado) &&
               admin.getContrasena().equals(contrasenaIngresada);
    }
}
/*
