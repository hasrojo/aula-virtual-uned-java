...
import AccesoADatos.ArchivoAsignacion;
import java.util.List;

///
///lógica de negocio para la asignación de cursos a estudiantes
///usa archivos .txt para almacenar las asignaciones
///
public class AsignacionLN {

    ///
    ///asigna un curso a un estudiante si no ha alcanzado el máximo 4
    ///retorna un mensaje indicando el resultado
    ///
    public String asignarCurso(String idEstudiante, String codigoCurso) {
        if (idEstudiante == null || idEstudiante.isEmpty() || codigoCurso == null || codigoCurso.isEmpty()) {
            return "Debe proporcionar el ID del estudiante y el código del curso.";
        }

        //delega al archivo
        return ArchivoAsignacion.asignarCurso(idEstudiante, codigoCurso);
    }

    ///
    ///obtiene la lista de cursos asignados al estudiante
    ///
    public List<String> obtenerCursosAsignados(String idEstudiante) {
        return ArchivoAsignacion.obtenerCursosAsignados(idEstudiante);
    }
}
/*
